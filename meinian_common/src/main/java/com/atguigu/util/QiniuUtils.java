...
public class QiniuUtils {
    ...
    public static String accessKey = "EMYRIKhSzl5uEDaTtdWJfOHUADiEINrWOAMXFSNW";
    public static String secretKey = "qe_kir2JcDN-S-Z41azIUNqBCJD_b7IQt8ac2vqM";
    public static String bucket = "meinian-2010";
